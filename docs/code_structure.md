...
| Staging audit scripts | `data/lit_curation/*`, production CSVs for duplicate checks | Review tables under `data/lit_curation/`, report under `docs/research/` | None | Not applicable | Staging/review-only data hygiene |
...
| `data/lit_curation/*` | Staging/research | Audit scripts, human review, future ingest proposals | Treating staging rows as production, source-quality ambiguity, duplicate promotion | Staging; promotion is scientific |
