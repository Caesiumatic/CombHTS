...
| --- | --- | --- | --- | --- | --- | --- |
| 2026-06-21 | Tier-1 harvest (REAL xTB) | gfn2-xtb | 36×13×16 = 7,488 | running (verified 06-22 08:18 CDT) | SGE 417538, Lop ib2; 856 cached per-species successes (~39% proxy); final survivors/failures TBD | [link](2026-06-21_tier1-harvest-real-7488.md) |
